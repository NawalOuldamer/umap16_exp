 ...
 *
 */
public class FilteredCollabrativeExpUsersScore {
	...
	public static void main(String[] args) throws IOException {
		...
		while(i.hasNext())		
		{
			...
			FileWriter fichier_resultat_with_expertise = new FileWriter("./collaborative_part/profile_filtred/fusion_expertise/"+number_of_topics+"_topics/rsv_collaboratif_number_of_topics_"+number_of_topics+"_query_"+courant.getChild("NUM").getText()+".res");
			int rank = 0;
