 ...
 *
 */
public class NotFilteredSimCollaborativeUsersScore {
	...
	public static void main(String[] args) throws IOException {
		...
		while(i.hasNext())		
		{
			...
			FileWriter fichier_resultat = new FileWriter("./collaborative_part/profile_not_filtred/similarity_weighted/rsv_collaboratif_prfile_not_filtered"+courant.getChild("NUM").getText()+".res");
			int rank = 0;
