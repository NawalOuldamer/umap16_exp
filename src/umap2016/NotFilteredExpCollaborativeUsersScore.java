 ...
 *
 */
public class NotFilteredExpCollaborativeUsersScore {
	...
	public static void main(String[] args) throws IOException {
		...
		while(i.hasNext())		
		{
			...
			FileWriter fichier_resultat = new FileWriter("./collaborative_part/profile_not_filtred/expertise_weighted/"+number_of_topics+"_topics/rsv_collaboratif_prfile_not_filtered"+courant.getChild("NUM").getText()+".res");
			int rank = 0;
