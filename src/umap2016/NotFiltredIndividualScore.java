 ...
 *
 */
public class NotFiltredIndividualScore {
	...
	public static void main(String[] args) throws IOException {
		...
		while(i.hasNext())		
		{
			...
			Scanner s = new Scanner(new File("./collaborative_part/non_filtred/rsv_user_docs_tags.res"));
			while (s.hasNextLine()) {
			...
			FileWriter fichier_resultat = new FileWriter("./individual_part/no_filtred/rsv_individual_number_of_query_"+courant.getChild("NUM").getText()+".res");
			int rank = 0;
