 ...
 *
 */
public class CollaborativeSimilaritiryUsersSelectedScoreFusion {
	...
	public static void main(String[] args) throws IOException {
		...
		while(i.hasNext())		
		{
			...
			FileWriter fichier_resultat = new FileWriter("./collaborative_part/similarity_resultats_fusion/users_selected/"+number_of_topics+"_topics/rsv_collaboratif_number_of_topics_"+number_of_topics+"_query_"+courant.getChild("NUM").getText()+".res");
